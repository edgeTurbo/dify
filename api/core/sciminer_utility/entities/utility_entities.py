...
class UtilityLabelEnum(Enum):
    ...
    MOLECULAR_DESIGN_AND_GENERATION = "molecular_design_and_generation"
    OTHER = "other"
...
class UtilityLabel(BaseModel):
    ...
    name: str = Field(..., description="The name of the utility")
    label: I18nObject = Field(..., description="The label of the utility")
    icon: str = Field(..., description="The icon of the utility")
